    ...
    <div class="row" id="gallery" data-aos="fade-up">
        <div class="col-lg-8 m-auto">
            <div class="customer-table-img-slider" id="icon">
                ...
                <?php for($i = 1; $i < 8; $i++) { ?>
    <img src="./images/customers/c<?php echo $i; ?>.jpg?<?php echo time(); ?>" 
         data-fancybox="table-slider"
         class="customer-table-img swiper-slide">
<?php } ?>
    ...
    if($result){
        while($row=mysqli_fetch_assoc($result)){  ?>       
            ...
            <div class="col-lg-4 swiper-slide">
                ...
                <img src="./images/team/<?php echo $row['member_image']; ?>?<?php echo time(); ?>" class="team-img">
